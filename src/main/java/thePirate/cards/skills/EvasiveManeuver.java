...
public class EvasiveManeuver extends AbstractDynamicCard {
    ...
    // TEXT DECLARATION
    public static final String ID = PirateMod.makeID(EvasiveManeuver.class.getSimpleName());
    public static final String IMG = makeCardPath(EvasiveManeuver.class.getSimpleName() + ".png", TYPE);
    // /TEXT DECLARATION/
