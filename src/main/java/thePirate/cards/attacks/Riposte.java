...
public class Riposte extends AbstractDynamicCard {
    ...
    public static final String ID = DefaultMod.makeID(Riposte.class.getSimpleName()); // USE THIS ONE FOR THE TEMPLATE;
    ...
    public void use(AbstractPlayer p, AbstractMonster m) {
        ...
        AbstractDungeon.actionManager.addToBottom(new GainEnergyAction(ENERGY_TO_GAIN));
