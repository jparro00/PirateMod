...
import thePirate.powers.ChemicalWarfarePower;

import static thePirate.DefaultMod.makeCardPath;

public class ChemicalWarfare extends AbstractDynamicCard {
    ...
    // TEXT DECLARATION
    public static final String ID = DefaultMod.makeID(ChemicalWarfare.class.getSimpleName());
    public static final String IMG = makeCardPath("ChemicalWarfare.png", TYPE);
    // /TEXT DECLARATION/
