...
public class InkShot extends AbstractCannonBallCard {
    ...
    public static final String ID = DefaultMod.makeID(InkShot.class.getSimpleName()); // USE THIS ONE FOR THE TEMPLATE;
    ...
    public void use(AbstractPlayer p, AbstractMonster m) {
        this.addToBot(new DamageAllEnemiesAction(p, damage, DamageInfo.DamageType.NORMAL, AbstractGameAction.AttackEffect.BLUNT_HEAVY));
