...
public class InkBlast extends AbstractDynamicCard {
    ...
    // TEXT DECLARATION
    public static final String ID = PirateMod.makeID(InkBlast.class.getSimpleName());
    public static final String IMG = makeCardPath("InkBlast.png", TYPE);
    // /TEXT DECLARATION/
