...
public class PirateTutorial extends FtueTip {
    private static final TutorialStrings tutorialStrings;
    public static final String[] txt;
    public static final String[] LABEL;
    private Texture img1 = ImageMaster.loadImage(PirateMod.getModID()+"Resources/images/ui/tip/pirate_t1.png");
    private Texture img2 = ImageMaster.loadImage(PirateMod.getModID()+"Resources/images/ui/tip/pirate_t2.png");
    private Texture img3 = ImageMaster.loadImage(PirateMod.getModID()+"Resources/images/ui/tip/pirate_t3.png");
    ...
    public void render(SpriteBatch sb) {
        ...
        FontHelper.renderSmartText(sb, FontHelper.panelNameFont, txt3, this.x + this.x3 + 400.0F * Settings.scale, (float)Settings.HEIGHT / 2.0F - FontHelper.getSmartHeight(FontHelper.panelNameFont, txt3, 700.0F * Settings.scale, 40.0F * Settings.scale) / 2.0F, 700.0F * Settings.scale, 40.0F * Settings.scale, Settings.CREAM_COLOR);
    ...
    static {
        tutorialStrings = CardCrawlGame.languagePack.getTutorialString("thePirate:PirateTutorials");
