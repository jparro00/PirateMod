...
public class DavyJonesLockerPower extends AbstractPower implements CloneablePowerInterface{
    ...
    public static final String POWER_ID = PirateMod.makeID("DavyJonesLockerPower");
    ...
    public DavyJonesLockerPower(final AbstractCreature owner, final AbstractCreature source, final int amount) {
        name = NAME;
        ID = POWER_ID;
    ...
    public AbstractPower makeCopy() {
        return new DavyJonesLockerPower(owner, source, amount);
    }
