...
public class CaptainsQuartersPower extends AbstractPower implements CloneablePowerInterface {
    ...
    public static final String POWER_ID = DefaultMod.makeID("CaptainsQuartersPower");
    ...
    public CaptainsQuartersPower(final AbstractCreature owner, final AbstractCreature source, final int amount) {
        name = NAME;
        ID = POWER_ID;
    ...
    public AbstractPower makeCopy() {
        return new CaptainsQuartersPower(owner, source, amount);
    }
}
